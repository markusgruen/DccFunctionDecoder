...
//   7.  select Tools -> Programmer -> SerialUPDI - 230400 Baud
//   8.  select Tools -> save EEPROM (...) -> EEPROM retained
//   9.  select Tools -> Burn Bootloader  <-- you must do this once, otherwise EEPROM will get erased whenever you flash the software
//   10. select Sketch -> Upload using Programmer (CRTL+SHIFT+U)
